...
* **Gradient Boosting Regressor** turned out to be the best model with  Mean Squared Logarithmic Error (MSLE) of **0.033**. 
...
<div style="text-align:center"><img alt="Image for post" class="ir is ab ac ae fw v hd" style="max-width:1000%;" width="500" height="250" src="https://raw.githubusercontent.com/Skumarr53/Amazon-Food-Reviews-Kaggle/master/feature_importances.png" sizes="700px"></div>
...
* Optimized KNN, Naive Bayes, SVM and Logistic classifiers using GridsearchCV to reach the best model.
...
<div style="text-align:center"><img alt="Image for post" class="ir is ab ac ae fw v hd" style="max-width:1000%;" width="380" height="300" src="https://raw.githubusercontent.com/Skumarr53/Quora-Question-Similarity-Kaggle/master/BestModel.png" sizes="700px"></div>
...
* Optimized **XGBoost** Regressor to reach best model with **0.967** Rmse.
...
<img alt="Image for post" class="fn ui s t u fa ai kq" width="480" height="250" src="https://miro.medium.com/max/1629/1*XpRCrTrSB-h1rEw-IrrcJQ.png" sizes="1715px">
...
<div style="text-align:center"><img alt="Image for post" class="ir is ab ac ae fw v hd" style="max-width:1000%;" width="380" height="350" src="https://raw.githubusercontent.com/Skumarr53/Planet-Amazon-Kaggle/master/snapshots/show_batch.png" sizes="700px"></div>
...
<div style="text-align:center"><img alt="Image for post" class="ir is ab ac ae fw v hd" style="max-width:1000%;" width="400" height="320" src="https://raw.githubusercontent.com/Skumarr53/Image-Caption-Generation-using-Fastai/master/snapshots/caption_gen.gif" sizes="700px"></div>
...
<div style="text-align:center"><img alt="Image for post" class="ir is ab ac ae fw v hd" style="max-width:1000%;" width="450" height="300" src="https://raw.githubusercontent.com/Skumarr53/Attention-is-All-you-Need-PyTorch/master/Snapshots/Fr2En_translate.gif" sizes="700px"></div>
